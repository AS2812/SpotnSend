...
export default function MapPage(){
  ...
  const legendItems = useMemo(() => {
    ...
    return [
      { key:"normal",   label: sevLabel(t, "normal" as any), className:"leg leg--normal" },
  ...
  return (
    <section>
      {/* FILTERS — Search left (half), Type far right. */}
      <div
      ...
      <div className="map-card">
        {((import.meta as any).env?.VITE_MAPTILER_KEY
          ...
          ? <MapLibreMap height={560} kind={fKind} query={q} />
        ...
        {/* LEGEND — background set inline via theme, no global CSS overrides */}
        <div
